<head>
                                    ...
                                    <div class="media align-items-center">
                                       ...
                                       <!--  <div class="mr-3">
                                        ...
                                        <div class="media-body overflow-hidden">
                                            <h5 class="font-size-16 mb-0 text-truncate"><a href="index.php" class="text-reset user-profile-show"><?php echo $group_name; ?></a> <i class="ri-record-circle-fill font-size-10 text-success d-inline-block ml-1"></i></h5>
                                        </div>
                                    </div>
                                </div>
    ...
    <form action="../controller/group_message_controller.php?g_id=<?php echo $g_id; ?>" method="POST">
                            ...
                            <ul class="list-unstyled mb-0">
                                 ...
                                 <?php
                                       ...
                                       // echo $sid;
                                        ...
                                        $grp="SELECT * FROM group_member WHERE m_id=$sid AND g_id=$g_id";
                                        ...
                                        $qry1="SELECT * FROM group_message WHERE g_id=$g_id OR Sid=$sid";
